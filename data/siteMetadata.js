...
const siteMetadata = {
  ...
  headerTitle: 'Abdul Ghaffar',
  description: 'thoughts from a wandering mind',
  language: 'en-us',
  siteUrl: 'https://www.aghaffar.com',
  siteRepo: 'https://github.com/aghaffar570/its.aghaffar',
  image: '/static/img/avatar.png',
  // socialBanner: '/static/img/twitter-card.png',
  // email: 'timothy.lin@alumni.ubc.ca',
  github: 'https://github.com/aghaffar570',
  // twitter: 'https://twitter.com/timlrxx',
  linkedin: 'https://www.linkedin.com/in/aghaffar570/',
  locale: 'en-US',
  analytics: {
    googleAnalytics: {
